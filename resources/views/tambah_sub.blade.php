    ...
    <div class="col-md-8 mx-auto">
        <div class="card shadow rounded">
            <div class="card-body">
                ...
                <form action="/simpan_sub" method="POST">
                    @csrf

                    {{-- Nama Sub Divisi --}}
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nama_subdivisi" name="nama_subdivisi" placeholder="Masukkan nama sub divisi" required>
