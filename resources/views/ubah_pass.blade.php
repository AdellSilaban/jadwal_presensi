...
<body>
  <div class="d-flex justify-content-center align-items-center vh-100 bg-light">
    <div class="card card-login shadow p-4 rounded-4" style="width: 100%; max-width: 400px;">
      <div class="text-center mb-4">
        <img src="{{ asset('assets/img/logo.png') }}" alt="Logo LPKKSK" class="logo mb-2" width="60">
        <h5 class="fw-bold mb-0">LPKKSK UKDW</h5>
        <small class="text-muted">Silakan ubah password akunmu.</small>
      </div>
      ...
      <form action="{{ route('update_pass') }}" method="POST">
        ...
        <div class="mb-3">
          <input type="password" id="password" name="password_baru" class="form-control" placeholder="Password Baru" required>
        </div>

        <div class="mb-2">
          <input type="password" id="confirm_password" name="password_baru_confirmation" class="form-control" placeholder="Konfirmasi Password" required>
        </div>
